 ...
 * 배포는 하루에
 * 한 번만 할 수 있으며, 하루의 끝에 이루어진다고 가정합니다.
...
public class Development {
    public void exeC(){
        ...
        int[] sppeds = {1, 30, 5}; // return 2, 1

        // Set 2 - 기대결과값 {1, 3, 2}
//        int[] progresses = {95, 90, 99, 99, 80, 9};
//        int[] sppeds = {1, 1, 1, 1, 1, 1};

        Arrays.stream(solution(progresses, sppeds)).forEach(e->{
